...
echo [3/7] Validating compose stack...
...
echo [4/7] Starting %A7_SYSTEM% containers...
...
echo [5/7] Waiting for core container health (timeout %HEALTH_TIMEOUT%s)...
...
echo [7/7] Container health report:
...
echo   Logs (LM Studio): docker logs -f a7_server_1-lmstudio
